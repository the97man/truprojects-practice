...
import { MTechPageData } from "../data/MTechPageData.js";

export default function MTechComp() {
    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="mt-5 mb-5 max-w-6xl mx-auto space-y-6">
          {MTechPageData.paragraphs.map((para, index) => (
            <p
              key={index}
              className={
                !isExpanded && index === 0
