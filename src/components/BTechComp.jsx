...
import { BTechPageData } from "../data/BTechPageData.js";

export default function BTechComp() {
    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="mt-5 mb-5 max-w-6xl mx-auto space-y-6">
          {BTechPageData.paragraphs.map((para, index) => (
            <p
              key={index}
              className={
                !isExpanded && index === 0
