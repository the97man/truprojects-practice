...
import { IEEEPageData } from "../data/IEEEPageData.js";

export default function IEEEComp() {
    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="mt-5 mb-5 max-w-6xl mx-auto space-y-6">
          {IEEEPageData.paragraphs.map((para, index) => (
            <p
              key={index}
              className={
                !isExpanded && index === 0
