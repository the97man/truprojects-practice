...
import { FinalYearPageData } from "../data/FinalYearPageData.js";

export default function FinalYearComp() {
    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="mt-5 mb-5 max-w-6xl mx-auto space-y-6">
          {FinalYearPageData.paragraphs.map((para, index) => (
            <p
              key={index}
              className={
                !isExpanded && index === 0
